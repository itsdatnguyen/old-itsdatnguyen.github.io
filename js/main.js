(function () {
    ...
    function updateParallax() {
        ...
        // disable stellar for devices under 1200px wide
    ...
    function updateImageSize() {
        // resize parallax images to the height of the viewport
        var height = Math.max(document.documentElement.clientHeight, window.innerHeight || 0);
        $(parallaxImageSelector).css("height", height);
    }
    ...
    $(document).ready(function () {
        // if is not mobile, then allow window resizing
    ...
    // on tablet orientation change and other related orientation events
